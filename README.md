...
**Unduh File `CONFIG_RULE_ONLINE_v3` dan ekstrak zip menggunakan `Zarchiver` atau pengekstrak yang lain. Download zip config** [DISINI](https://github.com/GboyGud/clash_for_android/files/11232508/CONFIG_RULE_ONLINE_v3.zip)
